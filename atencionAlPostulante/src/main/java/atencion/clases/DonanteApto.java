...
@Entity
@Table(name = "donanteApto")
public class DonanteApto {
    @Id
    ...
    public DonanteApto(long codDA, String nombre, String dni, String ocupacion, String lugarN, String fechaN, int edad, String distrito, String domicilio, String centroT, int telCasa, int celular, String fechaR, String sexo, String estadoC, String grupoS, String factorRh, String tipoDon) {
        this.codDA = codDA;
        this.nombre = nombre;
        this.dni = dni;
    ...
    public long getCodDA() {
        return codDA;
    }

    public void setCodDA(long codDA) {
        this.codDA = codDA;
    }
