...
public class Donante {
    ...
    public Donante(long codD, String nombre, String dni, String ocupacion, String lugarN, String fechaN, int edad, String distrito, String domicilio, String centroT, int telCasa, int celular, String fechaR, String sexo, String estadoC, String grupoS, String factorRh, String tipoDon) {
        this.codD = codD;
        this.nombre = nombre;
        this.dni = dni;
